...
class myFunctions {
    ...
    public function step1($id,$total,$current_timestamp,$userID,$table,$staffID){
        ...
        $query = "INSERT INTO ORDERS VALUES(ORDERS_SEQ.nextval,$total,TIMESTAMP '$current_timestamp','N',$table,$userID,NULL)";
    ...
    public function printBasket(){
        ...
        echo '<div class="userDetails"><div>';
        echo '<p>Please select your table number: </p><form method="post" action="../pages/payment.php">
                          <select name="tblNo">';
                          for($i=1; $i < 15; $i++){
